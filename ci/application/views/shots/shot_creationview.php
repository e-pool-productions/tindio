...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?php if($new) echo 'Creating Shot'; else echo 'Editing Shot'; ?></h4>
        </div>
        <div class="modal-body">
			<?php 
				echo validation_errors();
				$link = $new ? 'shots/form/create' : 'shots/form/edit';
				...
				foreach ($shots as $item)
			        $shot[] = $item['title'];
			    echo form_dropdown('order', $shot, $oldOrder - 1) . br(1);
				echo form_close();
			?> 
			</div>
